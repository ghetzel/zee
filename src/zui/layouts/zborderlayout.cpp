...
void ZBorderLayout::addItem(QLayoutItem *item)
{
    add(item, West);
}

void ZBorderLayout::addWidget(QWidget *widget, Position position)
{
    add(new QWidgetItem(widget), position);
}

Qt::Orientations ZBorderLayout::expandingDirections() const
{
    return Qt::Horizontal | Qt::Vertical;
}

bool ZBorderLayout::hasHeightForWidth() const
{
    return false;
}

int ZBorderLayout::count() const
{
    return list.size();
}
...
QSize ZBorderLayout::minimumSize() const
{
...
QSize ZBorderLayout::sizeHint() const
{
    return calculateSize(SizeHint);
}

QLayoutItem *ZBorderLayout::takeAt(int index)
{
