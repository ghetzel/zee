...
class QMPProcess : public QProcess
{
	...
	//	++ GWH 2010-09-10
		void mediaInfoUpdated(QMPwidget::MediaInfo);
...
//	++ GWH 2010-09-10
	connect(m_process, SIGNAL(mediaInfoUpdated(QMPwidget::MediaInfo)),
		this, SIGNAL(mediaInfoUpdated(QMPwidget::MediaInfo)));
}
